...
public class Mp4ParserWrapper {
    ...
    public static void append(
        ...
        final com.googlecode.mp4parser.authoring.Movie movieA = MovieCreator.build(new FileDataSourceImpl(secondFile));
        final com.googlecode.mp4parser.authoring.Movie movieB = MovieCreator.build(new FileDataSourceImpl(firstFile));
